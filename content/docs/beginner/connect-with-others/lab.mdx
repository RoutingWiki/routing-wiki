...
<Tabs items={['utils.conf', 'functions.conf', 'Upstream bird.conf', 'Downstream bird.conf', 'Peer bird.conf']}>
  <Tab value="utils.conf">
...
<Tab value="Downstream bird.conf">
...
<Tabs items={['Upstream', 'Downstream', 'Peer']}>
  <Tab value="Upstream">
