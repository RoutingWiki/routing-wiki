...
<Tabs items={['Node A', 'Node B', 'Node C']} groupId="node">
...
<Tabs items={['Node A', 'Node C']} groupId="node">
...
<Tabs items={['Upstream A', 'Node A', 'Node B', 'Node C', 'Upstream C']} groupId="node">
<Tab value="Upstream A">
