...
export const remarkRfcLinkIetf: Plugin<[RemarkRfcLinkOptions?], Root> =
  function (this: ThisParameterType<typeof remarkRfcLink>, options = {}) {
    return remarkRfcLink.call(this, { ...presets.ietf, ...options });
  };
...
export const remarkRfcLinkWithHyphen: Plugin<[RemarkRfcLinkOptions?], Root> =
  function (this: ThisParameterType<typeof remarkRfcLink>, options = {}) {
    return remarkRfcLink.call(this, { ...options, supportHyphen: true });
  };
